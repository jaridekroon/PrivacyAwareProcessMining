...
import org.processmining.plugins.privacytest.log2logInfo.Log2LogInfoTime;

import com.fluxicon.slickerbox.factory.SlickerFactory;

public class XLog2DfgTimeDialog extends JPanel{
	...
	public class VariantDefault extends Variant {
		...
		public IMLog2IMLogInfo getIMLog2IMLogInfo() {
			return new Log2LogInfoTime();
		}
	}

	@SuppressWarnings("unchecked")
	public XLog2DfgTimeDialog(XLog log) {
		...
		//variant
		{
			...
			variantCombobox = factory.createComboBox(
					new Variant[] { new VariantDefault()});
			{
